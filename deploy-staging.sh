...
#${PROJECT_NAME_STG} come from travis setting
...
kubectl apply -f ./cart/k8s.yaml
kubectl apply -f ./category/k8s.yaml
kubectl apply -f ./customer-authentication/k8s.yaml
kubectl apply -f ./customer-info/k8s.yaml
kubectl apply -f ./inventory/k8s.yaml
